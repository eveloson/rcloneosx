...
class ViewControllerRestoreOrg: NSViewController, SetConfigurations, Remoterclonesize, Setcolor, VcMain, Checkforrclone, Abort {
...
extension ViewControllerRestoreOrg: NSTableViewDataSource {
    func numberOfRows(in _: NSTableView) -> Int {
        return self.configurations?.getConfigurationsSyncandCopy()?.count ?? 0
    }
}

extension ViewControllerRestoreOrg: NSTableViewDelegate {
...
extension ViewControllerRestoreOrg: UpdateProgress {
...
extension ViewControllerRestoreOrg: DismissViewController {
...
extension ViewControllerRestoreOrg: Count {
    func maxCount() -> Int {
...
extension ViewControllerRestoreOrg: Setrestorepath {
    func setrestorepath() {
...
extension ViewControllerRestoreOrg: OpenQuickBackup {
